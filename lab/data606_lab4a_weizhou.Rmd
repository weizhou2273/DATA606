...
This distribution is also right skewed. The shape is very similar to the distribution of population
...
mean(area)
```
There is a difference between the means of samp1 and samp2.
Sample with size of 1000 will have a more accurate estimate of the population mean. 
...
5000 elements in sample_means50. 
The current distribution is close to a symmetric normal distribution. 
If we collected 50000 sample means it will be a more perfect normal distribution.   
```{r}
mean(sample_means50)
...
sample_means_small
```
Each element represent the mean of areas random sample with size of 50.
...
The larger the sample size, the sample mean is closer to the actual population mean. 
The spread is shorter. 
* * *
## On your own
...
The shaple is normal distribution.    
...
hist(sample_means50)
sample_means50_mean = mean(sample_means50)
actual_mean = mean(price)
```
##### Mean of sample_mean50 is `r sample_means50_mean`.
##### Actual mean is `r actual_mean` 
...
sample_means150_mean = mean(sample_means150)
```
##### Mean of sample_mean150 is `r sample_means150_mean`.
##### Mean of sample_mean50 is `r sample_means50_mean`.
##### differenct between sample_mean50_mean and sample_mean150_mean is `r sample_means50_mean-sample_means150_mean`.
...
hist(sample_means150)
```
###### The sample_means150 has smaller range of `r range(sample_means150)` comparing to range of sample_means50 `r range(sample_means50)`
I will prefer a distribution with a small spread. 
